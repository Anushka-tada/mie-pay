...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup function
    return () => {
      if (typeof window !== "undefined" && $.fn.fullpage && $.fn.fullpage.destroy) {
  ...
  return (
    <div className="relative" id="fullpage">
      ...
      <div className="aboutpage relative section" data-anchor="about">
        ...
        <div className="herosection flex flex-col items-center relative">
          ...
          <p className="about-text text-center">
            Your secure digital wallet designed for seamless payments. We simplify transactions with transparent tracking and zero hidden fees. Soon expanding to multiple services, Mie Pay makes managing your money effortless and worry-free.
          </p>
          <div className="app-outer flex flex-wrap gap-4 items-center justify-center mt-9">
            <p className="text-lg download">DOWNLOAD NOW</p>
           <div className="flex">
           <a href="https://apps.apple.com/ca/app/mie-pay/id6742891477" target="blank">
              <img src="/assets/app-store.png" alt="Logo" className="app-store" />
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.app.miepay" target="blank">
              <img src="/assets/google-pay.png" alt="Logo" className="google-pay" />
            </a>
           </div>
          </div>
        </div>
      ...
      {/* Contact Page */}
      <div className="contactpage relative section" data-anchor="contact">
        ...
        <div className="contact mt-5 flex flex-col items-center">
          <div className="contact-sections flex flex-wrap-reverse justify-center xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center gap-20">
            <div className="contact-text flex flex-col xl:gap-4  lg:gap-4 md:gap-4 sm:gap-3 gap-1  items-center text-center">
              <img src="/assets/contact.png" alt="Logo" className="contact-h" />
              <h3 className="text-xl text-white font-semibold xl">Have any questions about Mie Pay?</h3>
              <p className="text-zinc-400 text-1">Our dedicated team is ready to assist you anytime! Reach us at.</p>
              <div>
                <h3 className="text-2xl text-white font-bold xl">Email</h3>
                <p className="text-2xl text-white xl">info@miepay.ca</p>
              </div>
              <div>
                <h3 className="text-2xl text-white font-bold xl">Call</h3>
                <p className="text-2xl text-white xl">+1 (416)827-0039</p>
              </div>
              <p className="text-zinc-400 text-1">for instant support with your digital wallet needs.</p>
            </div>
            ...
            <div className="contact-form p-9 rounded-4xl flex flex-col justify-center">
              ...
              <form onSubmit={formik.handleSubmit} className='flex flex-col gap-2'>
                ...
                <div className='flex justify-center '>
                  <button type="submit" className="send-button py-3 flex justify-center rounded-lg mt-7">
                    <p className='text-lg text-white font-semibold'>Send</p>
                  </button>
                </div>
              </form>
