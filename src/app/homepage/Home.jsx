  ...
  >
   ...
   <a href="/about">   <li className="text-white text-lg uppercase">About</li></a>
    <li className="text-white text-lg uppercase">Contact</li>
     ...
     <img src="/assets/logocenter3.png" alt="Logo" />
     <h1 className='font-bold xl:text-4xl lg:text-4xl md:text-4xl sm:text-3xl text-3xl text-white  mt-4'>Refer.Earn.Repeat</h1>
     </div>
